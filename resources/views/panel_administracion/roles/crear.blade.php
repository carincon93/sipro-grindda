...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('roles.store') }}">
            ...
            {{-- <notificacion-rol :roles="{{ $roles }}" :errors="{{ $errors }}"></notificacion-rol> --}}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="bajo" type="radio" name="nivelSeguridad" value="1" class="custom-control-input" {{ old('nivelSeguridad') == 1 ? 'checked' : '' }} required>
                        <label class="custom-control-label" for="bajo">Bajo (Aprendices, Investigadores, Otros)</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="alto" type="radio" name="nivelSeguridad" value="5" class="custom-control-input" {{ old('nivelSeguridad') == 5 ? 'checked' : '' }} required>
                ...
                <div class="col-md-9">
                    @foreach ($roles as $key => $rolBd)
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="rol-slug{{$key+1}}" name="usuarioNotificacion[]" value="{{ __($rolBd->slug) }}" {{ old('usuarioNotificacion') == $rolBd->slug ? 'checked' : '' }}>
            ...
            <div class="{{ $errors->has('permisos') ? ' is-invalid' : '' }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ver-caja-ideas" name="permisos[]" value="{{ __('ver-caja-ideas') }}" {{ old('permisos') == 'ver-caja-ideas' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ver-caja-ideas">{{ __('Ver ideas de la caja de ideas') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="editar-caja-ideas" name="permisos[]" value="{{ __('editar-caja-ideas') }}" {{ old('permisos') == 'editar-caja-ideas' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="editar-caja-ideas">{{ __('Editar ideas de la caja de ideas') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="eliminar-caja-ideas" name="permisos[]" value="{{ __('eliminar-caja-ideas') }}" {{ old('permisos') == 'eliminar-caja-ideas' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-formativo" name="permisos[]" value="{{ __('proyecto-formativo') }}" {{ old('permisos') == 'proyecto-formativo' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="proyecto-formativo">{{ __('Proyecto formativo') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-investigacion" name="permisos[]" value="{{ __('proyecto-investigacion') }}" {{ old('permisos') == 'proyecto-investigacion' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="proyecto-investigacion">{{ __('Proyecto de investigación') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-innovacion" name="permisos[]" value="{{ __('proyecto-innovacion') }}" {{ old('permisos') == 'proyecto-innovacion' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="proyecto-innovacion">{{ __('Proyecto de innovación') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-modernizacion" name="permisos[]" value="{{ __('proyecto-modernizacion') }}" {{ old('permisos') == 'proyecto-modernizacion' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="proyecto-modernizacion">{{ __('Proyecto de modernización') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-divulgacion" name="permisos[]" value="{{ __('proyecto-divulgacion') }}" {{ old('permisos') == 'proyecto-divulgacion' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="proyecto-divulgacion">{{ __('Proyecto de divulgación') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="proyecto-laboratorios" name="permisos[]" value="{{ __('proyecto-laboratorios') }}" {{ old('permisos') == 'proyecto-laboratorios' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="generar-presupuesto" name="permisos[]" value="{{ __('generar-presupuesto') }}" {{ old('permisos') == 'generar-presupuesto' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="generar-presupuesto">{{ __('Añadir presupuesto') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="info-grupo-investigacion" name="permisos[]" value="{{ __('info-grupo-investigacion') }}" {{ old('permisos') == 'info-grupo-investigacion' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    <label for="permisos" class="col-sm-3 col-form-label">
                        {{ __('Permisos de información básica') }}
                        <p class="small">Áreas de conocimiento, centro de formación</p>
                    </label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="crear-informacion" name="permisos[]" value="{{ __('crear-informacion') }}" {{ old('permisos') == 'crear-informacion' ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ver-informacion" name="permisos[]" value="{{ __('ver-informacion') }}" {{ old('permisos') == 'ver-informacion' ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="editar-informacion" name="permisos[]" value="{{ __('editar-informacion') }}" {{ old('permisos') == 'editar-informacion' ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="eliminar-informacion" name="permisos[]" value="{{ __('eliminar-informacion') }}" {{ old('permisos') == 'eliminar-informacion' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="crear-convocatoria" name="permisos[]" value="{{ __('crear-convocatoria') }}" {{ old('permisos') == 'crear-convocatoria' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="crear-convocatoria">{{ __('Crear convocatoria') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="editar-convocatoria" name="permisos[]" value="{{ __('editar-convocatoria') }}" {{ old('permisos') == 'editar-convocatoria' ? 'checked' : '' }}>
                            <label class="custom-control-label" for="editar-convocatoria">  {{ __('Editar convocatoria') }}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="eliminar-convocatoria" name="permisos[]" value="{{ __('eliminar-convocatoria') }}" {{ old('permisos') == 'eliminar-convocatoria' ? 'checked' : '' }}>
