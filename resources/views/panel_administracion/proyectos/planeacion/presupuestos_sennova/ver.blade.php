...
@section('content')
    ...
    <div class="container">
        ...
        <h1>Presupuesto SENNOVA</h1>

        @if ($presupuesto->evaluacion)
            @if ($presupuesto->evaluacion->recomendacion)
                <div class="alert alert-danger" role="alert">
                    <strong>Recomendación: </strong>{{ $presupuesto->evaluacion->recomendacion }} <a href="{{ route('presupuestos_sennova.edit', [$proyecto->id, $presupuesto->id]) }}" class="text-danger d-block"><u>Por favor realiza la correción</u></a>
